package com.litianyu.basics.project0.examples;/*
 *
...
import com.litianyu.basics.project0.StdDraw;
import com.litianyu.basics.project0.StdRandom;

public class StdDrawDemo {
	public static String imageToDraw = "./data/nbody/advice.png";
